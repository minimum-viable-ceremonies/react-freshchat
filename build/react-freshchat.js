(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'lodash/fp', 'react', 'browser-monads'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('lodash/fp'), require('react'), require('browser-monads'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.fp, global.react, global.browserMonads);
    global.reactFreshchat = mod.exports;
  }
})(this, function (exports, _fp, _react, _browserMonads) {
  'use strict';
  ...
  var widget = exports.widget = function widget() {
    ...
    if (_browserMonads.window.fcWidget) return _browserMonads.window.fcWidget;
  ...
  var loadScript = function loadScript() {
    ...
    if (document.getElementById(id) || _browserMonads.window.fcWidget) return;
  ...
  var FreshChat = function (_React$Component) {
    ...
    _createClass(FreshChat, [{
      ...
      value: function init(settings) {
        ...
        if (_browserMonads.window.fcWidget) {
          _browserMonads.window.fcWidget.init(settings);
          if (settings.onInit) {
            settings.onInit();
          }
        } else {
          ...
          if (_browserMonads.window.fcWidget) {
            ...
            try {
              earlyCalls.dequeueAll(function (method, value) {
                ...
                (_window$fcWidget = _browserMonads.window.fcWidget)[method].apply(_window$fcWidget, _toConsumableArray(value));
              });
            } catch (e) {
              console.error(e);
            }
